package uk.gov.nationalarchives.tdr.draftmetadatavalidator.validations

import uk.gov.nationalarchives.tdr.draftmetadatavalidator.Lambda.ValidationParameters
import uk.gov.nationalarchives.tdr.draftmetadatavalidator.{Error, FileError, ValidationErrors}
