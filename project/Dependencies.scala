...
object Dependencies {
  ...
  lazy val metadataValidation = "uk.gov.nationalarchives" %% "tdr-metadata-validation" % "0.0.104" exclude ("uk.gov.nationalarchives", "da-metadata-schema_3")
  ...
  lazy val awsSsm = "software.amazon.awssdk" % "ssm" % "2.30.23"
