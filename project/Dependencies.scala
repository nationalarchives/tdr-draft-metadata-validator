...
object Dependencies {
  ...
  lazy val metadataValidation = "uk.gov.nationalarchives" %% "tdr-metadata-validation" % "0.0.148" exclude ("uk.gov.nationalarchives", "da-metadata-schema")
  ...
  lazy val awsSsm = "software.amazon.awssdk" % "ssm" % "2.31.59"
