...
object Dependencies {
  ...
  lazy val metadataValidation = "uk.gov.nationalarchives" %% "tdr-metadata-validation" % "0.0.89" exclude ("uk.gov.nationalarchives", "da-metadata-schema_3")
  lazy val schemaUtils = "uk.gov.nationalarchives" %% "tdr-schema-utils" % "0.0.89"
  ...
  lazy val awsSsm = "software.amazon.awssdk" % "ssm" % "2.29.27"
