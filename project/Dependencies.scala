...
object Dependencies {
  ...
  val metadataSchemaVersion = "0.0.131"

  lazy val scalaCsv = "com.github.tototoshi" %% "scala-csv" % "2.0.0"
  lazy val scalaTest = "org.scalatest" %% "scalatest" % "3.2.20"
  lazy val metadataValidation = "uk.gov.nationalarchives" %% "tdr-metadata-validation" % "0.0.228" exclude ("uk.gov.nationalarchives", "da-metadata-schema")
  ...
  lazy val s3Utils = "uk.gov.nationalarchives" %% "s3-utils" % "0.1.331"
